...
static const struct bin_attribute *mtk_codec_bin_attrs[] = {
	&codec_dev_attr_reg,
	NULL,
};
...
static int mt6368_pmic_reg_clear_get(struct snd_kcontrol *kcontrol,
      struct snd_ctl_elem_value *ucontrol)
{
...
static const struct snd_kcontrol_new mt6368_snd_misc_controls[] = {
	...
	SOC_ENUM_EXT("PMIC_REG_CLEAR", misc_control_enum[0],
		     mt6368_pmic_reg_clear_get, mt6368_rcv_dcc_set),
