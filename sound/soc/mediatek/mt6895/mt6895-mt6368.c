...
/*
 *  mt6895-mt6368.c  --  mt6895 mt6368 ALSA SoC machine driver
 *
...
static const struct soc_enum mt6895_spk_type_enum[] = {
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6895_spk_type_str),
			    mt6895_spk_type_str),
	SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(mt6895_spk_i2s_type_str),
			    mt6895_spk_i2s_type_str),
};

static int mt6895_spk_type_get(struct snd_kcontrol *kcontrol,
...
static int mt6895_spk_i2s_out_type_get(struct snd_kcontrol *kcontrol,
				       struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6895_spk_i2s_in_type_get(struct snd_kcontrol *kcontrol,
				      struct snd_ctl_elem_value *ucontrol)
{
...
static int mt6895_mt6368_spk_amp_event(struct snd_soc_dapm_widget *w,
...
static const struct snd_soc_dapm_widget mt6895_mt6368_widgets[] = {
...
static const struct snd_kcontrol_new mt6895_mt6368_controls[] = {
	...
	SOC_ENUM_EXT("MTK_SPK_TYPE_GET", mt6895_spk_type_enum[0],
		     mt6895_spk_type_get, NULL),
	SOC_ENUM_EXT("MTK_SPK_I2S_OUT_TYPE_GET", mt6895_spk_type_enum[1],
 ...
 * BE i2s need assign snd_soc_ops = mt6895_mt6368_i2s_ops
 */
static int mt6895_mt6368_i2s_hw_params(struct snd_pcm_substream *substream,
...
static const struct snd_soc_ops mt6895_mt6368_i2s_ops = {
	.hw_params = mt6895_mt6368_i2s_hw_params,
};

static int mt6895_mt6368_mtkaif_calibration(struct snd_soc_pcm_runtime *rtd)
{
	...
	miso0_need_calib = mt6895_afe_gpio_is_prepared(MT6895_AFE_GPIO_DAT_MISO0_ON);
	miso1_need_calib = mt6895_afe_gpio_is_prepared(MT6895_AFE_GPIO_DAT_MISO1_ON);
	miso2_need_calib = mt6895_afe_gpio_is_prepared(MT6895_AFE_GPIO_DAT_MISO2_ON);

	mt6895_afe_gpio_request(afe, true, MT6895_DAI_ADDA, 1);
	mt6895_afe_gpio_request(afe, true, MT6895_DAI_ADDA, 0);
	mt6895_afe_gpio_request(afe, true, MT6895_DAI_ADDA_CH34, 1);
	mt6895_afe_gpio_request(afe, true, MT6895_DAI_ADDA_CH34, 0);
	...
	mt6895_afe_gpio_request(afe, false, MT6895_DAI_ADDA, 0);
	mt6895_afe_gpio_request(afe, false, MT6895_DAI_ADDA_CH34, 1);
	mt6895_afe_gpio_request(afe, false, MT6895_DAI_ADDA_CH34, 0);
...
static int mt6895_mt6368_init(struct snd_soc_pcm_runtime *rtd)
{
	struct snd_soc_component *component =
		snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	struct mtk_base_afe *afe = snd_soc_component_get_drvdata(component);
	...
	ops.enable_dc_compensation = mt6895_enable_dc_compensation;
	ops.set_lch_dc_compensation = mt6895_set_lch_dc_compensation;
	ops.set_rch_dc_compensation = mt6895_set_rch_dc_compensation;
	ops.adda_dl_gain_control = mt6895_adda_dl_gain_control;
	...
	/* mtkaif calibration */
	mt6895_mt6368_mtkaif_calibration(rtd);
...
static const struct snd_pcm_hardware mt6895_mt6368_vow_hardware = {
...
static int mt6895_mt6368_vow_startup(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	dev_info(afe->dev, "%s(), start\n", __func__);
	snd_soc_set_runtime_hwparams(substream, &mt6895_mt6368_vow_hardware);

	mt6895_afe_gpio_request(afe, true, MT6895_DAI_VOW, 0);
...
static void mt6895_mt6368_vow_shutdown(struct snd_pcm_substream *substream)
{
	struct snd_soc_pcm_runtime *rtd = substream->private_data;
	struct snd_soc_component *component =
			snd_soc_rtdcom_lookup(rtd, AFE_PCM_NAME);
	...
	mt6895_afe_gpio_request(afe, false, MT6895_DAI_VOW, 0);
...
static const struct snd_soc_ops mt6895_mt6368_vow_ops = {
	.startup = mt6895_mt6368_vow_startup,
	.shutdown = mt6895_mt6368_vow_shutdown,
};
...
&& IS_ENABLED(CONFIG_SND_SOC_MTK_OFFLOAD))
...
static struct snd_soc_dai_link mt6895_mt6368_dai_links[] = {
	...
	},
	{
		...
		.ops = &mt6895_mt6368_i2s_ops,
		.no_pcm = 1,
		.capture_only = 1,
		.ignore_suspend = 1,
		.ignore_pmdown_time = 1,
		.be_hw_params_fixup = mt6895_i2s_hw_params_fixup,
...
static struct snd_soc_card mt6895_mt6368_soc_card = {
	.name = "mt6895-mt6368",
	.owner = THIS_MODULE,
	.dai_link = mt6895_mt6368_dai_links,
	.num_links = ARRAY_SIZE(mt6895_mt6368_dai_links),

	.controls = mt6895_mt6368_controls,
	.num_controls = ARRAY_SIZE(mt6895_mt6368_controls),
	.dapm_widgets = mt6895_mt6368_widgets,
...
dai_link->codecs->of_node = headset_codec_node;
	...
	/*
	 * ASoC 7.2 puts the card on the internal unbind list when a component
	 * is not ready yet and retries the bind from snd_soc_add_component().
	 * Returning -EPROBE_DEFER here would re-run this probe (and hence
	 * snd_soc_bind_card) on top of that retry machinery, which kept the
	 * card from ever being instantiated.
	 */
...
static const struct of_device_id mt6895_mt6368_dt_match[] = {
	{.compatible = "mediatek,mt6895-mt6368-sound",},
	{}
};
#endif

static const struct dev_pm_ops mt6895_mt6368_pm_ops = {
	.poweroff = snd_soc_poweroff,
	.restore = snd_soc_resume,
};

static struct platform_driver mt6895_mt6368_driver = {
	.driver = {
		.name = "mt6895-mt6368",
#if IS_ENABLED(CONFIG_OF)
		.of_match_table = mt6895_mt6368_dt_match,
#endif
		.pm = &mt6895_mt6368_pm_ops,
	},
...
MODULE_AUTHOR("Qinzhong Deng <qinzhong.deng@mediatek.com>");
MODULE_LICENSE("GPL v2");
MODULE_ALIAS("mt6895 mt6368 soc card");
