...
static const struct scp_domain_data scp_domain_data_mt6895[] = {
	...
	[MT6895_POWER_DOMAIN_MM_INFRA] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x0C24, 0x0C28, 0x0C20, 0x0C2C,
				MT6895_TOP_AXI_PROT_EN_MMSYS1_MM_INFRA_2ND),
			BUS_PROT_IGN(IFR_TYPE, 0x0C44, 0x0C48, 0x0C40, 0x0C4C,
				MT6895_TOP_AXI_PROT_EN_INFRASYS0_MM_INFRA),
			BUS_PROT_IGN(IFR_TYPE, 0x0C64, 0x0C68, 0x0C60, 0x0C6C,
			...
			BUS_PROT_IGN(NEMI_TYPE, 0x0084, 0x0088, 0x008C, 0x008C,
				MT6895_NEMI_PROT_EN_EMISYS0_MM_INFRA),
			BUS_PROT_IGN(SEMI_TYPE, 0x0084, 0x0088, 0x008C, 0x008C,
				MT6895_SEMI_PROT_EN_EMISYS0_MM_INFRA),
		},
	...
	[MT6895_POWER_DOMAIN_MM_PROC_DORMANT] = {
		...
		.bp_table = {
			...
			BUS_PROT_IGN(IFR_TYPE, 0x0C34, 0x0C38, 0x0C30, 0x0C3C,
				MT6895_TOP_AXI_PROT_EN_MMSYS2_MM_PROC_2ND),
		},
		.sram_table = {
...
static int mt6895_scpsys_probe(struct platform_device *pdev)
{
	...
	writel(readl(scp->base + 0xF30) & ~(BIT(9) | BIT(10)),
	       scp->base + 0xF30);
