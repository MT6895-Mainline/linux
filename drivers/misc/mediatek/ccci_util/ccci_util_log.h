...
/* qqcandy: the vendor tree got this from the mrdump driver, which is not part
 * of this tree. mt-plat/mrdump.h provides an inert static-inline stub, so use
 * that instead of a dangling extern declaration.
 */
