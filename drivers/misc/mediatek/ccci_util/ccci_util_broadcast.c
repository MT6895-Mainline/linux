...
#ifdef CONFIG_COMPAT
/* qqcandy: only referenced by broad_cast_fops below; static avoids the
 * -Wmissing-prototypes warning the vendor build did not have.
 */
...
int ccci_util_broadcast_init(void)
{
	...
	/* qqcandy: 6.18 class_create() takes only the name */
