...
/*
 * qqcandy: permanently-false gate for the unsafe LK/modem tag parse. Nothing
 * sets it; the tunable runtime probe moved to the ccci_probe.ko module. See
 * the declaration in ccci_util_lib_main.h.
 */
bool ccci_util_probe;
