...
/* qqcandy: for ccci_log_init() and the other lib prototypes */
...
/* qqcandy: static; only used by this file's fops */
static unsigned int ccci_log_poll(struct file *fp, struct poll_table_struct *poll)
{
	unsigned int mask = 0;
...
/* qqcandy: static; only used by this file's fops */
static unsigned int ccci_dump_fops_poll(struct file *fp, struct poll_table_struct *poll)
{
