...
static const struct attribute_group ccci_default_attr_group = {
	.attrs = ccci_default_attrs,
};

static const struct attribute_group *ccci_default_groups[] = {
	&ccci_default_attr_group,
	NULL
};
