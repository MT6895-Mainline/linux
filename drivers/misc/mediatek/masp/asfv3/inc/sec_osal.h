...
/*
 * qqcandy: osal_set_kernel_fs()/osal_restore_fs() were dropped because
 * get_fs()/set_fs()/mm_segment_t no longer exist in 6.18. ASF_GET_DS and
 * ASF_PUT_DS were their only users.
 */
